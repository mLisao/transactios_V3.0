package com.jiangguo.transactios.config;
...
public class BmobConstants {
	 ...
	 * 存放发送图片的目录
	 */
	public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/交易/image/";
	
	/**
	 * 我的头像保存目录
	 */
	public static String MyAvatarDir = "/sdcard/交易/avatar/";
	/**
	 * 拍照回调
	 */
